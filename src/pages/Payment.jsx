        ...
        <div className="w-full lg:w-[686px] flex flex-col items-start gap-12">
          <div className="flex flex-col items-start gap-2 w-full">
            ...
            <p className="text-[#7C8DB0] text-base font-normal">
              Select a payment method below. Gabibook processes your payment
          ...
          <div className="w-full flex flex-col items-start justify-start gap-5">
            <div className="flex flex-col items-start justify-start gap-2">
              ...
              <p className="text-[#7C8DB0] text-base font-normal">
                Gabibook is free to use as a guest, but if you create an account
          ...
          <div className="w-full flex flex-col items-start justify-start gap-5">
            <div className="flex flex-col items-start justify-start gap-3">
              ...
              <p className="text-[#7C8DB0] text-base font-normal">
                ...
                are eligible for a free refund. All flights booked on Gabibook are
